  ...
  return (
    <main className="min-h-dvh bg-oboon-dark flex flex-col">
      ...
      <header className="px-5 pt-12 pb-6 text-center">
        <Link href="/" className="inline-block bg-oboon-accent text-oboon-dark text-xs font-black px-4 py-1.5 rounded-full mb-4 tracking-wide hover:brightness-110 transition-all">
          OBOON
        </Link>
